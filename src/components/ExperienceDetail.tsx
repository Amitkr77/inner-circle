  ...
  return (
    ...
    >
      ...
      <div className="relative h-[60vh] min-h-[400px] overflow-hidden mx-6 md:mx-12 rounded-[2rem]">
        <img
          src={exp.image || 'https://source.unsplash.com/1600x900/?nature,water'} // Fallback image
          alt={exp.title}
        ...
        >
          <span
            className={`border px-4 py-1.5 rounded-full text-[10px] uppercase tracking-[0.2em] font-bold backdrop-blur-md ${VIBE_COLORS[exp.vibe] || VIBE_COLORS.Nature}`}
          >
            {exp.vibe}
          </span>
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-16">
          ...
          <div className="lg:col-span-2 space-y-16">
            <section>
              <p className="text-[10px] uppercase tracking-[0.3em] font-bold text-accent-emerald mb-4">
            ...
            {exp.highlights && exp.highlights.length > 0 && (
              <section>
                <p className="text-[10px] uppercase tracking-[0.3em] font-bold text-accent-emerald mb-6">
                  What's Included
                </p>
            ...
            <section>
              <div className="flex items-center gap-3 mb-8">
                ...
                <p className="text-[10px] uppercase tracking-[0.3em] font-bold text-accent-emerald">
                ...
                <div>
                  {exp.itinerary.map((item, idx) => (
                    ...
                    >
                      ...
                      <span className="text-[10px] uppercase font-bold tracking-[0.2em] text-accent-emerald block mb-1.5">
                        Day {item.day}
                      </span>
                      ...
                      {item.meals.length > 0 && (
                        <div className="flex flex-wrap items-center gap-2">
                          ...
                          {item.meals.map((meal, mIdx) => (
                            <span
                              key={mIdx}
                              className="text-[9px] font-bold uppercase tracking-wider bg-white/5 border border-white/[0.07] px-2.5 py-1 rounded-md text-white/40"
                            >
                              {meal}
                            </span>
                          ))}
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-28 space-y-5">
                ...
                <div className="space-y-3 mb-8">
                  {[
                    ...
                    },
                    {
                      icon: Users,
                      label: "Group Size",
                      value: `Max ${exp.groupSize} People`,
                    },
              ...
              <div className="glass-immersive rounded-2xl p-6">
                <div className="flex items-center gap-2 mb-4">
                  <div className="flex">
                    {[1, 2, 3, 4, 5].map((i) => (
                      <Star
                        key={i}
                        className="w-3.5 h-3.5 fill-accent-orange text-accent-orange"
                      />
                    ))}
                  </div>
                ...
                <p className="text-[10px] uppercase tracking-widest text-white/25 mt-3 font-bold">
                  — Sarah Chen, Stripe
                </p>
              </div>
