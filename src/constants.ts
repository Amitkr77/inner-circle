...
export const EXPERIENCES: Experience[] = [
  ...
  // INTERNATIONAL
  {
    ...
    nights: 4,
    image:
      "https://images.unsplash.com/photo-1530122037265-a5f1f91d3b99?auto=format&fit=crop&q=80&w=2070",
    pricePerHead: 145000,
    groupSize: 6,
    description: "Elite networking among the peaks of Europe.",
    highlights: [
      "Gstaad Skiing Retreat",
      "Zermatt Private Helitour",
      "Luxury Chocolate Workshop",
      "Strategic Alpine Sprints",
    ],
    itinerary: [],
  },
  {
    ...
    nights: 9,
    image:
      "https://images.unsplash.com/photo-1559628233-eb1b1a45564b?auto=format&fit=crop&q=80&w=2070",
    pricePerHead: 85000,
    groupSize: 12,
    description: "Co-work and rejuvenate in Bali’s lush rice fields.",
    highlights: [
      "Ubud Yoga & Meditation",
      "Digital Nomad Beach Sprints",
  ...
  },
  {
    ...
    nights: 5,
    image:
      "https://images.unsplash.com/photo-1531219432768-9f540ce91ef3?auto=format&fit=crop&q=80&w=2070",
    pricePerHead: 120000,
    groupSize: 8,
    description: "Lead under the magic of the Aurora Borealis.",
    highlights: [
      "Aurora Hunting Cruise",
      "Ice Hotel Overnight",
      "Dog Sledding Strategy Hike",
      "Oslo Cultural Tour",
    ],
    itinerary: [],
  },
  {
    ...
    nights: 11,
    image:
      "https://images.unsplash.com/photo-1469474968028-56623f02e42e?auto=format&fit=crop&q=80&w=2070",
    pricePerHead: 195000,
    groupSize: 6,
  ...
  },
  {
    ...
    highlights: [
      "Zipline Cloud Canopy",
      "Volcanic Thermal Springs",
      "Sloth & Toucan Sanctuary",
      "Coffee Estate Workshop",
    ],
    itinerary: [],
  },
  {
    ...
    nights: 6,
    image:
      "https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?auto=format&fit=crop&q=80&w=2070",
    pricePerHead: 135000,
    groupSize: 8,
    description: "Tradition meets tomorrow in the heart of Japan.",
    highlights: [
      "Zen Meditation with Monks",
      "Grand Tea Ceremony",
      "Bamboo Grove Forest Bathing",
      "Technological Kyoto Tour",
    ],
    itinerary: [],
  },
];
