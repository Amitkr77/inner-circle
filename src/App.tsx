...
import {
Navbar, Hero, ExperienceShowcase, CorporateExperience,
CommunitySection, HowItWorks, StatsSection, ContactSection,
Footer, PastExpeditions
...
// ✅ HOME PAGE
return ( <div className="relative min-h-screen selection:bg-accent-pink/30"> <GlowBackground />
