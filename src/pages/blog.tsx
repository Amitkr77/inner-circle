...
export default function Blog() {
  ...
  const featuredCards = [
    {
      ...
      time: "6 min read",
      date: "Apr 2025",
      slug: "why-founders-confuse-motion-with-progress",
    },
    {
  ...
  return (
    <div className="mx-auto max-w-7xl overflow-hidden bg-[#050505] font-[family-name:var(--font-sans)] text-white pt-28">
        ...
        {featuredCards.map((card) => (
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 right-0 p-8">
              ...
              <h2 className="mb-3.5 whitespace-pre-line text-2xl font-extrabold leading-[1.2] tracking-[-0.02em] text-white/[0.9]">
                {card.title}
              </h2>
              <div className="flex items-center gap-2.5">
                <span className="text-[10px] font-bold uppercase tracking-[0.14em] text-white/[0.18]">{card.author}</span>
                <span className="h-[3px] w-[3px] rounded-full bg-white/20" />
                <span className="text-[10px] font-bold uppercase tracking-[0.14em] text-white/[0.18]">{card.time}</span>
                <span className="h-[3px] w-[3px] rounded-full bg-white/20" />
                <span className="text-[10px] font-bold uppercase tracking-[0.14em] text-white/[0.18]">{card.date}</span>
      ...
      {/* ── Wide Card ── */}
      <div
        onClick={() => navigate(`/blog/${toSlug("Solitude is a competitive advantage")}`)}
      ...
      >
        ...
        <div className="absolute inset-y-0 left-0 flex w-[55%] flex-col justify-center px-11 py-10">
          ...
          <h2 className="mb-4 text-[32px] font-black leading-[1.1] tracking-[-0.03em] text-white/[0.9]">
            Solitude is a<br />competitive advantage
          </h2>
          ...
          <div className="flex items-center gap-2.5">
            <span className="text-[10px] font-bold uppercase tracking-[0.14em] text-white/[0.18]">Marcus Reid</span>
            <span className="h-[3px] w-[3px] rounded-full bg-white/20" />
            <span className="text-[10px] font-bold uppercase tracking-[0.14em] text-white/[0.18]">9 min read</span>
            <span className="h-[3px] w-[3px] rounded-full bg-white/20" />
            <span className="text-[10px] font-bold uppercase tracking-[0.14em] text-white/[0.18]">Feb 2025</span>
          </div>
        </div>
      </div>
      ...
      <div className="flex items-center gap-12 border-y border-white/[0.07] bg-[#0d0d0d] px-11 py-14 mb-[2px]">
        <div className="-mt-2 shrink-0 text-[80px] font-black leading-[0.7] text-emerald-400/[0.12]">
          &ldquo;
        </div>
      ...
      <div className="mb-[2px] grid grid-cols-3 gap-[2px]">
        {gridCards.map((card) => (
          <div
            key={card.title}
            onClick={() => navigate(`/blog/${toSlug(card.title)}`)}
          ...
          >
            ...
            <p className="mb-2.5 text-base font-extrabold leading-[1.3] tracking-[-0.015em] text-white/[0.8]">
              {card.title}
            </p>
      ...
      {/* ── Topics ── */}
      <div className="mb-[2px] border-y border-white/[0.07] px-11 py-12">
      ...
      {/* ── Newsletter ── */}
      <div className="grid grid-cols-2 items-center gap-12 border-t border-white/[0.07] bg-[#0a0a0a] px-11 py-16">
        <div>
        ...
        <div className="flex flex-col gap-2.5">
          <div className="flex">
            <input
              className="flex-1 border border-white/10 bg-[#0d0d0d] px-[18px] py-3.5 font-[family-name:var(--font-sans)] text-[13px] text-white/50 outline-none placeholder:text-white/15"
