...
export default function DarjeelingPage({ onBack }: Props) {
  const data = [
  {
    icon: "✔️",
  ...
  return (
    ...
    <div className="min-h-screen bg-[#131313] text-[#E5E2E1] font-['Manrope',sans-serif]">
      <nav className="fixed top-0 w-full z-50 bg-[#131313]/60 backdrop-blur-xl shadow-2xl shadow-black/40">
        <div className="flex justify-between items-center max-w-7xl mx-auto px-6 md:px-12 py-5">
          <button onClick={onBack} className="flex items-center gap-2 text-[#E9C176] font-bold hover:opacity-80 transition-opacity group">
            <ArrowLeft className="w-4 h-4 group-hover:-translate-x-1 transition-transform" />Back to Expeditions
          </button>
      ...
      <section className="relative min-h-screen flex items-end overflow-hidden pt-20">
        <div className="absolute inset-0 z-0">
          <img className="w-full h-full object-cover opacity-40" src="https://images.unsplash.com/photo-1544735716-392fe2489ffa?auto=format&fit=crop&q=80&w=2070" alt="Darjeeling" referrerPolicy="no-referrer" />
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 pb-20 w-full">
          <p className="font-bold text-[#E9C176] uppercase tracking-[0.4em] text-xs mb-6">Nature · West Bengal, India</p>
          <h1 className="font-['Epilogue',sans-serif] text-5xl md:text-8xl font-black tracking-tighter mb-6 leading-[0.9]" style={{textShadow:'0 0 40px rgba(233,193,118,0.2)'}}>Mystical<br/>Darjeeling<br/>Heights</h1>
          <p className="text-xl text-[#D1C5B4] max-w-2xl font-light leading-relaxed mb-8">The closest hill station retreat from Patna. Scenic and serene tea trails amidst the Himalayan foothills.</p>
          <div className="flex flex-wrap gap-4 text-xs uppercase tracking-widest text-[#9a8f80]">
            ...
            <span className="border border-[#4e4639] px-4 py-2">Group of 12</span>
            <span className="border border-[#E9C176]/40 px-4 py-2 text-[#E9C176]">₹18,500 / Person</span>
          </div>
        </motion.div>
      </section>
    ...
    {/* what's included */}
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-6 gap-4">
            <div className="md:col-span-3 bg-[#1c1b1b] p-12 hover:bg-[#201f1f] transition-colors">
              ...
              <h3 className="font-['Epilogue',sans-serif] text-2xl font-bold mb-4">UNESCO Heritage Toy Train</h3>
              <p className="text-[#D1C5B4] font-light">Ride the iconic Darjeeling Himalayan Railway — a UNESCO World Heritage steam locomotive winding through misty mountains.</p>
            </div>
            <div className="md:col-span-3 bg-[#1c1b1b] p-12 hover:bg-[#201f1f] transition-colors">
              <p className="text-2xl mb-3">🌅</p>
              <h3 className="font-['Epilogue',sans-serif] text-2xl font-bold mb-4">Sunrise at Tiger Hill</h3>
              <p className="text-[#D1C5B4] font-light">Pre-dawn drive to Tiger Hill for the legendary sunrise view of Kanchenjunga — the world's third highest peak in golden light.</p>
            </div>
            <div className="md:col-span-2 bg-[#1c1b1b] p-12 hover:bg-[#201f1f] transition-colors">
              <p className="text-xl mb-3">🍵</p>
              <h4 className="font-['Epilogue',sans-serif] text-xl font-bold mb-4">Organic Tea Garden Stay</h4>
              <p className="text-sm text-[#D1C5B4] font-light">Stay in heritage bungalows surrounded by rolling green tea estates.</p>
            </div>
            <div className="md:col-span-2 bg-[#1c1b1b] p-12 hover:bg-[#201f1f] transition-colors">
              <p className="text-xl mb-3">🏯</p>
              <h4 className="font-['Epilogue',sans-serif] text-xl font-bold mb-4">Monastery Trail</h4>
              <p className="text-sm text-[#D1C5B4] font-light">Visit Ghoom Monastery and Batasia Loop — ancient Buddhist temples in the clouds.</p>
            </div>
            <div className="md:col-span-2 bg-[#1c1b1b] p-12 hover:bg-[#201f1f] transition-colors">
              <p className="text-xl mb-3">🧘</p>
              <h4 className="font-['Epilogue',sans-serif] text-xl font-bold mb-4">Mountain Mindfulness</h4>
              <p className="text-sm text-[#D1C5B4] font-light">Guided meditation and leadership clarity workshops at altitude.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="relative py-32 overflow-hidden">
        <div className="absolute inset-0 z-0"><img className="w-full h-full object-cover opacity-15" src="https://images.unsplash.com/photo-1544735716-392fe2489ffa?auto=format&fit=crop&q=80&w=2070" alt="bg" referrerPolicy="no-referrer" /></div>
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid md:grid-cols-2 gap-24 items-center">
            <div>
              <p className="font-bold text-[#E9C176] uppercase tracking-[0.2em] text-xs mb-4">Location: Darjeeling, West Bengal</p>
              <h2 className="font-['Epilogue',sans-serif] text-4xl md:text-5xl font-bold tracking-tight mb-8">Serenity in the Queen of Hills.</h2>
              <p className="text-[#D1C5B4] mb-8 leading-relaxed font-light">3 nights in India's most iconic hill station. The closest mountain escape from Patna — just a night train away.</p>
              <ul className="space-y-6">
                {[{icon:'🚆',title:'Easy from Patna',desc:'Overnight train Patna → NJP, then scenic drive to Darjeeling. No flights needed.'},{icon:'🌿',title:'Nature & Clarity',desc:'Tea garden air, monastery silence, and Himalayan vistas that reset your thinking.'},{icon:'👥',title:'Perfect Group Size',desc:'12 people — intimate enough for real conversations, large enough for energy.'}].map((item,i)=>(
            ...
            <div className="bg-[#1c1b1b] p-4 aspect-square">
              <div className="w-full h-full border border-[#4e4639]/20 flex items-center justify-center">
                <div className="text-center p-12"><p className="text-6xl mb-6 opacity-20">📍</p><h3 className="font-['Epilogue',sans-serif] text-2xl font-bold mb-2">Tea Garden Estate</h3><p className="text-xs uppercase tracking-widest text-[#9a8f80]">Heritage Bungalow, Darjeeling Hills</p></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-32 bg-[#0e0e0e]">
        <div className="max-w-4xl mx-auto px-6 md:px-12">
          ...
          <div className="space-y-0">
            {[
              {day:'01',title:'Arrival & Tea Garden Tour',desc:'Arrive at NJP/Bagdogra. Scenic mountain drive. Evening tea tasting and welcome dinner.',meals:['Welcome Tea','Dinner'],active:true},
              {day:'02',title:'Tiger Hill Sunrise',desc:'Pre-dawn drive to Tiger Hill. Kanchenjunga sunrise. Toy train ride through misty hills.',meals:['Breakfast','Lunch','Dinner'],active:false},
              {day:'03',title:'Monastery & Strategy Day',desc:'Visit Ghoom Monastery, Batasia Loop. Afternoon leadership workshop and team debrief.',meals:['Breakfast','Lunch','Dinner'],active:false},
              {day:'04',title:'Departure',desc:'Morning meditation in the tea gardens. Farewell breakfast and transfer to NJP.',meals:['Breakfast'],active:false},
            ].map((item,i)=>(
      ...
      <section className="py-32 bg-[#1c1b1b]">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[{tier:'Early Bird',price:'₹16,500',items:['3-night heritage stay','Group Activities','All Meals'],popular:false},{tier:'Standard',price:'₹18,500',items:['Everything in Early','Strategy Session','Network Access','Content Package'],popular:true},{tier:'Premium',price:'₹24,000',items:['Everything in Standard','Private Bungalow Suite','Airport Transfers','Priority Access'],popular:false}].map((t,i)=>(
              <div key={i} className={`p-12 flex flex-col relative ${t.popular?'bg-[#2a2a2a] border-2 border-[#E9C176] scale-105':'bg-[#201f1f] border border-[#4e4639]/20'}`}>
                ...
                <ul className={`space-y-3 mb-12 text-sm flex-grow font-light ${t.popular?'text-[#E5E2E1] font-medium':'text-[#D1C5B4]'}`}>{t.items.map((item,ii)=><li key={ii}>✓ {item}</li>)}</ul>
      ...
      <section className="py-40 bg-[#0e0e0e] text-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-12">
          <h2 className="font-['Epilogue',sans-serif] text-4xl md:text-5xl font-bold mb-8 leading-tight">The mountains are calling.</h2>
          <p className="text-[#D1C5B4] mb-12 font-light text-lg">Your clarity isn't in the city. It's in the mist above Darjeeling.</p>
          ...
          <div className="flex items-center justify-center gap-4 mt-6 text-xs uppercase tracking-[0.3em] text-[#9a8f80]"><span>Limited to 12 people</span><span className="h-1 w-1 rounded-full bg-[#E9C176]"/><span>Spots filling fast</span></div>
        </div>
      </section>
      {/* footer */}
      <footer className="w-full py-16 px-12 bg-[#0E0E0E] border-t border-[#4E4639]/15">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8 max-w-7xl mx-auto">
          <div className="text-lg font-bold">Aetheris Expeditions</div>
