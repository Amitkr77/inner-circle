...
export default function KashmirPage({ onBack }: Props) {
  const data = [
  {
    icon: "✔️",
 ...
 const mentors = [
  ...
  return (
    // Navbar
    <div className="min-h-screen bg-[white] text-[#E5E2E1] font-['Manrope',sans-serif]">
      ...
      <section className="relative min-h-screen flex items-end overflow-hidden pt-20">
        <div className="absolute inset-0 z-0">
          <img className="w-full h-full object-cover opacity-40" src="https://images.unsplash.com/photo-1595815771614-ade9d652a45d?auto=format&fit=crop&q=80&w=2070" alt="Kashmir" referrerPolicy="no-referrer" />
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 pb-20 w-full">
          <p className="font-bold text-[#E9C176] uppercase tracking-[0.4em] text-xs mb-6">Luxury · Srinagar/Gulmarg, Kashmir</p>
          <h1 className="font-['Epilogue',sans-serif] text-5xl md:text-8xl font-black tracking-tighter text-[#E5E2E1] mb-6 leading-[0.9]" style={{ textShadow: '0 0 40px rgba(233,193,118,0.2)' }}>
            Kashmir:<br />Paradise<br />Protocol
          </h1>
          <p className="text-xl text-[#D1C5B4] max-w-2xl font-light leading-relaxed mb-8">A royal retreat in the heart of Kashmir. Easy flights from Patna to Srinagar.</p>
          <div className="flex flex-wrap gap-4 text-xs uppercase tracking-widest text-[#9a8f80]">
            <span className="border border-[#4e4639] px-4 py-2">7 Days · 6 Nights</span>
            <span className="border border-[#4e4639] px-4 py-2">Group of 8</span>
            <span className="border border-[#E9C176]/40 px-4 py-2 text-[#E9C176]">₹32,000 / Person</span>
          </div>
        </motion.div>
      </section>
     ...
     <section className="py-32 bg-[#131313] text-center">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-6 gap-4">
            <div className="md:col-span-3 bg-[#1c1b1b] p-12 hover:bg-[#201f1f] transition-colors">
              ...
              <h3 className="font-['Epilogue',sans-serif] text-2xl font-bold mb-4">Luxury Houseboat Stay</h3>
              <p className="text-[#D1C5B4] font-light">Wake up on the legendary Dal Lake in a premium heritage houseboat. Hand-carved interiors, traditional Kashmiri hospitality.</p>
            </div>
            <div className="md:col-span-3 bg-[#1c1b1b] p-12 hover:bg-[#201f1f] transition-colors">
              <p className="text-2xl mb-3">🚡</p>
              <h3 className="font-['Epilogue',sans-serif] text-2xl font-bold mb-4">Gulmarg Gondola</h3>
              <p className="text-[#D1C5B4] font-light">Ride the world's highest gondola to snow-covered meadows. Skiing, snowboarding, or simply standing above the clouds.</p>
            </div>
            <div className="md:col-span-2 bg-[#1c1b1b] p-12 hover:bg-[#201f1f] transition-colors">
              <p className="text-xl mb-3">🚤</p>
              <h4 className="font-['Epilogue',sans-serif] text-xl font-bold mb-4">Private Shikara Rides</h4>
              <p className="text-sm text-[#D1C5B4] font-light">Exclusive sunrise shikara on Dal Lake with breakfast served on the water.</p>
            </div>
            <div className="md:col-span-2 bg-[#1c1b1b] p-12 hover:bg-[#201f1f] transition-colors">
              <p className="text-xl mb-3">🍛</p>
              <h4 className="font-['Epilogue',sans-serif] text-xl font-bold mb-4">Wazwan Feast</h4>
              <p className="text-sm text-[#D1C5B4] font-light">Kashmir's royal 36-course feast. An experience that bonds teams over shared culture.</p>
            </div>
            <div className="md:col-span-2 bg-[#1c1b1b] p-12 hover:bg-[#201f1f] transition-colors">
              <p className="text-xl mb-3">🏔️</p>
              <h4 className="font-['Epilogue',sans-serif] text-xl font-bold mb-4">Alpather Lake Trek</h4>
              <p className="text-sm text-[#D1C5B4] font-light">High-altitude frozen lake trek with panoramic Himalayan views.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="relative py-32 overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img className="w-full h-full object-cover opacity-15" src="https://images.unsplash.com/photo-1595815771614-ade9d652a45d?auto=format&fit=crop&q=80&w=2070" alt="bg" referrerPolicy="no-referrer" />
        </div>
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid md:grid-cols-2 gap-24 items-center">
            <div>
              <p className="font-bold text-[#E9C176] uppercase tracking-[0.2em] text-xs mb-4">Location: Srinagar & Gulmarg</p>
              <h2 className="font-['Epilogue',sans-serif] text-4xl md:text-5xl font-bold tracking-tight mb-8">Royal Luxury in Heaven on Earth.</h2>
              <p className="text-[#D1C5B4] mb-8 leading-relaxed font-light">6 nights of unmatched luxury in the most beautiful valley in the world. Direct flights from Patna make this a seamless escape.</p>
              <ul className="space-y-6">
                {[
                  { icon: '👑', title: 'Unmatched Luxury', desc: 'Handpicked heritage properties and exclusive experiences not available to the general public.' },
                  { icon: '✈️', title: 'Direct from Patna', desc: 'Patna → Srinagar direct flight, 1.5 hours. The easiest luxury escape from Bihar.' },
                  { icon: '🤝', title: 'Small Group', desc: 'Max 8 people ensures deeply personal experience and strong team bonds.' },
                ].map((item, i) => (
            ...
            <div className="bg-[#1c1b1b] p-4 aspect-square">
              <div className="w-full h-full border border-[#4e4639]/20 flex items-center justify-center">
                <div className="text-center p-12">
                  ...
                  <h3 className="font-['Epilogue',sans-serif] text-2xl font-bold mb-2">Dal Lake & Gulmarg</h3>
                  <p className="text-xs uppercase tracking-widest text-[#9a8f80]">Heritage Houseboat + Mountain Resort</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-32 bg-[#0e0e0e]">
        <div className="max-w-4xl mx-auto px-6 md:px-12">
          <h2 className="font-['Epilogue',sans-serif] text-3xl font-bold mb-20 text-center">The 7-Day Royal Journey</h2>
          <div className="space-y-0">
            {[
              { day: '01', title: 'Lakeside Welcome', desc: 'Arrive Srinagar airport. Check into premium houseboat on Dal Lake. Sunset shikara ride.', meals: ['Wazwan Dinner'], active: true },
              { day: '02', title: 'Gulmarg Gondola Ride', desc: "World's highest gondola. Snow meadows, skiing, and an executive strategy session at altitude.", meals: ['Breakfast', 'Lunch', 'Dinner'], active: false },
              { day: '03', title: 'Trek to Alpather', desc: 'High altitude frozen lake trek with a picnic lunch at the summit. Evening masterminds.', meals: ['Breakfast', 'Lunch', 'Dinner'], active: false },
              { day: '04', title: 'Dal Lake Day', desc: 'Morning shikara to the floating markets. Afternoon cooking masterclass for the Wazwan feast.', meals: ['Breakfast', 'Lunch', 'Dinner'], active: false },
              { day: '05', title: 'Sonamarg Excursion', desc: 'Drive through the meadow of gold. River crossing on horses, glacier viewpoints.', meals: ['Breakfast', 'Lunch', 'Dinner'], active: false },
              { day: '06', title: 'Strategy & Reflection', desc: 'Final deep-work sessions. 90-day commitment circle. Bonfire farewell evening.', meals: ['Breakfast', 'Dinner'], active: false },
              { day: '07', title: 'Departure', desc: 'Morning chai on the lake, then transfer to Srinagar airport.', meals: ['Breakfast'], active: false },
            ].map((item, i) => (
              <div key={i} className={`relative pl-12 ${i < 6 ? 'pb-16 border-l border-[#4e4639]/30' : 'border-l border-[#4e4639]/30'}`}>
      ...
      <section className="py-32 bg-[#1c1b1b]">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <h2 className="font-['Epilogue',sans-serif] text-4xl font-bold text-center mb-20">Secure Your Invitation</h2>
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { tier: 'Early Invitation', price: '₹29,000', items: ['Houseboat 5-night stay', 'Group Activities', 'All Meals'], popular: false },
              { tier: 'Standard', price: '₹32,000', items: ['Everything in Early', '1:1 Strategy Session', 'Network Access', 'Content Package'], popular: true },
              { tier: 'Premium', price: '₹42,000', items: ['Everything in Standard', 'Private Suite Upgrade', 'Airport Transfers', 'Priority Access'], popular: false },
            ].map((t, i) => (
              <div key={i} className={`p-12 flex flex-col relative ${t.popular ? 'bg-[#2a2a2a] border-2 border-[#E9C176] scale-105' : 'bg-[#201f1f] border border-[#4e4639]/20'}`}>
                ...
                <ul className={`space-y-3 mb-12 text-sm flex-grow font-light ${t.popular ? 'text-[#E5E2E1] font-medium' : 'text-[#D1C5B4]'}`}>
                  {t.items.map((item, ii) => <li key={ii}>✓ {item}</li>)}
                </ul>
                <button className={`w-full py-4 text-sm uppercase tracking-widest font-bold transition-all ${t.popular ? 'bg-[#E9C176] text-[#412d00] hover:shadow-[0_0_30px_rgba(233,193,118,0.3)]' : 'border border-[#9a8f80] text-[#E5E2E1] hover:bg-[#E5E2E1] hover:text-[#131313]'}`}>Apply</button>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-40 bg-[#0e0e0e] text-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-12">
          <h2 className="font-['Epilogue',sans-serif] text-4xl md:text-5xl font-bold mb-8 leading-tight">This isn't a trip. It's a transformation.</h2>
          <p className="text-[#D1C5B4] mb-12 font-light text-lg">Your next breakthrough isn't in a conference hall. It's on the shores of Dal Lake.</p>
